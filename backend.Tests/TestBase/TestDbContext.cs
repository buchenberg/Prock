...
public static class TestDbContext
{
    ...
    public static async Task<ProckDbContext> CreateSeededAsync(IFixture fixture, string? databaseName = null)
    {
        ...
        // Seed with test data
        var mockRoutes = fixture.CreateMany<backend.Data.Entities.MockRoute>(3).ToList();
        var prockConfig = fixture.Create<backend.Data.Entities.ProckConfig>();
        var openApiDocs = fixture.CreateMany<backend.Data.Entities.OpenApiSpecification>(2).ToList();
